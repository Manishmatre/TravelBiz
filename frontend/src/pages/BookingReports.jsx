    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">Analyze trends and generate reports on booking data</p>
        </div>
        <Button>
            ...
            <div className="p-5">
                <div className="flex items-center">
                    ...
                    <div className="ml-4">
                        ...
                        <p className="text-2xl font-bold text-gray-900">$1,250,450</p>
                    </div>
                </div>
            </div>
        </Card>
        <Card>
            <div className="p-5">
                <div className="flex items-center">
                    ...
                    <div className="ml-4">
                        <p className="text-sm font-medium text-gray-500">Total Bookings (YTD)</p>
        ...
        <Card>
            <div className="p-5">
                <div className="flex items-center">
                    ...
                    <div className="ml-4">
                        <p className="text-sm font-medium text-gray-500">New Clients (YTD)</p>
